...
export default class HomePage extends Component{
    ...
    onClickHandler = () => {
      ...
      this.props.history.push(`/PSI&${this.state.selectedOptionSub.label}&${this.state.selectedOptionTrait.label}`);
  }
    ...
    console.log(`Option selected:`, selectedOptionTrait);
      ...
      render() {
       ...
       <div className="custom-file">
          ...
          <input type="file" className="form-control" id="customFile" name="file" onChange={this.onChangeHandler} />
        </div>
